...
void ControlChangePanelComponent::resized()
{
    ...
    infoLabelBottomRight.setBounds(display.physicalToLogical(juce::Rectangle<int>(posLabelsX+91, 168+SomiLookAndFeel::fontSizeSmall+5, 50, SomiLookAndFeel::fontSizeSmall)));
}
